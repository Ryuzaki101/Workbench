...
/**
 * This interface defines symbolic constants for numeric TELNET protocol command
 * and option codes. Any class that needs to use these constants must implement
 * this interface. The meanings of these constants are defined in the various
 * TELNET RFCs (RFC 854 to RFC 861, and others).
 */
