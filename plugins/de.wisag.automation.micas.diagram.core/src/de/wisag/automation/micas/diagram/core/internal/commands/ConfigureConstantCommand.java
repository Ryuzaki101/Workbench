...
public class ConfigureConstantCommand extends ConfigureElementCommand {

    public ConfigureConstantCommand(ConfigureRequest request, EClass configurableType) {
        super(request);
    ...
    protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
        ...
        Constant constant = (Constant) request.getElementToConfigure();
        BlockUtils.configureConstant(constant);
        return CommandResult.newOKCommandResult(constant);
    }
