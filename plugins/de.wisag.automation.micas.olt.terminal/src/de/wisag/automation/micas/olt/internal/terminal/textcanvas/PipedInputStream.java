...
public class PipedInputStream extends InputStream {
    ...
    private class BoundedByteBuffer {
        ...
        /**
         * @return the bytes available for {@link #read()} Must be called with a
         *         lock on this!
         */
         ...
         *
         * @param b
         *            byte to write to the buffer
         * @throws InterruptedException
         *             when the thread is interrupted while waiting for the
         *             buffer to become ready Must be called with a lock on
         *             this!
         */
    ...
    /**
     * An output stream that calls {@link PipedInputStream#textAvailable} every
     * time data is written to the stream. The data is written to
     ...
     * @throws InterruptedException
     *             when the thread is interrupted while waiting for the buffer
     *             to become ready
     */
    ...
    /**
     * Closing a <tt>PipedInputStream</tt> has no effect. The methods in this
            ...
            synchronized (fQueue) {
                ...
                if (n < len && fQueue.available() > 0) {
                    ...
                    if (nn == 0 && fQueue.isClosed()) {
                        // if no byte was read, return -1 to indicate end of
                        // stream
