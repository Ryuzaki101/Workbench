...
public interface ITerminalViewControl {
    ...
    /**
     * @param write
     *            a single character to terminal
     */
    ...
    /**
     * @param inputField
     *            null means no input field is shown
     */
    ...
    /**
     * @return the maximum number of lines to display in the terminal view. -1
     *         means unlimited.
     */
    public int getBufferLineLimit();

    /**
     * @param bufferLineLimit
     *            the maximum number of lines to show in the terminal view. -1
     *            means unlimited.
     */
