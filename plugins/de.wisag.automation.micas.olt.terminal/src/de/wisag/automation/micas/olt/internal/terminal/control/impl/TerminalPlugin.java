...
import de.wisag.automation.micas.olt.internal.terminal.control.actions.ImageConsts;
...
public class TerminalPlugin extends AbstractUIPlugin {
    ...
    public static final String PLUGIN_ID = "de.wisag.automation.micas.olt.terminal"; //$NON-NLS-1$
