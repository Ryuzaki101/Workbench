...
public class SnapshotChanges implements ISnapshotChanges {
    ...
    /**
     * The lines that need to be copied into the snapshot (lines that have not
     * changed don't have to be copied)
     */
    ...
    /**
     * The result is only defined if {@link #isInInterestWindow(int, int)}
     * returns true!
     *
     * @param line
     *            the line <b>before</b> {@link #fitLineToWindow(int)} has been
     *            called!
     * @param size
     ...
     *
     * @see
     * de.wisag.automation.micas.olt.internal.terminal.model.ISnapshotChanges#
     * markLineChanged(int)
     */
    @Override
    ...
    /**
     * Some incompatible scrolling occurred. We cannot do the scroll
     ...
     * @see
     * de.wisag.automation.micas.olt.internal.terminal.model.ISnapshotChanges#
     * copyChangedLines(de.wisag.automation.micas.olt.terminal.model.
     * ITerminalTextData,
     * de.wisag.automation.micas.olt.terminal.model.ITerminalTextData)
     */
    @Override
