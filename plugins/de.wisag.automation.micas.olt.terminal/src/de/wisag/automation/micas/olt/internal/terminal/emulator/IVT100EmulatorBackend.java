...
public interface IVT100EmulatorBackend {
     ...
     * of the line. 01234 0 123
     */
    void insertCharacters(int charactersToInsert);

    /**
     * Erases from cursor to end of screen, including cursor position. Cursor
     * does not move.
     */
    ...
    /**
     * Inserts n lines at line with cursor. Lines displayed below cursor move
     * down. Lines moved past the bottom margin are lost. This sequence is
     ...
     * left. This creates a space character at right margin. This character has
