...
import de.wisag.automation.micas.olt.terminal.model.StyleColor;
...
public class StyleMap {
    ...
    private static final String PREFIX = "de.wisag.automation.micas.olt.internal."; //$NON-NLS-1$
    ...
    private void initBackgroundColors() {
        if (fInvertColors) {
            ...
            setColor(fColorMapBackground, WHITE_FOREGROUND, 50, 50, 50); // only
                                                                         // used
                                                                         // when
                                                                         // colors
                                                                         // are
    ...
    public void updateFont() {
        ...
        if (!fProportional) {
            // measure font in boldface, too, and if wider then treat like
            // proportional
