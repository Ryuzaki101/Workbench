...
public interface ITerminalTextData extends ITerminalTextDataReadOnly {
    ...
    /**
     * Sets the dimensions of the data. If the dimensions are smaller than the
     * current dimensions, the lines will be chopped. If the dimensions are
     * bigger, then the new elements will be filled with 0 chars and null Style.
     *
     * @param height
     * @param width
     */
     ...
     *
     * @param line
     *            line must be >=0 and < height
     * @param column
     *            column must be >=0 and < width
     * @param c
     ...
     *            column must be >=0 and < width
     * @param chars
     *            the new characters at this position
     * @param style
     *            the style or null
     */
    ...
    /**
     * Set a subrange of an array of characters showing in the same
     * {@link Style}.
     *
     * @param line
     *            line must be >=0 and < height
     ...
     *            the new characters at this position
     * @param start
     *            the start index in the chars array
     * @param len
     *            the number of characters to insert. Characters beyond width
     *            are not inserted.
     * @param style
     *            the style or null
     */
    ...
    //
    // /**
    // * Makes this line an extension to the previous line. Wrapped lines get
    // folded back
    ...
    /**
     * Shifts some lines up or down. The "empty" space is filled with
     * <code>'\000'</code> chars and <code>null</code> {@link Style}
     * <p>
     ...
     * </pre>
     *
     * Shift a region of 3 lines <b>up</b> by one line
     * <code>shift(1,3,-1)</code>
     *
     * <pre>
     * 0 aaaa
     * 1 cccc
     ...
     * </pre>
     *
     * Shift a region of 3 lines <b>down</b> by one line
     * <code>shift(1,3,1)</code>
     *
     * <pre>
     * 0 aaaa
     ...
     *
     * @param startLine
     *            the start line of the shift
     * @param size
     *            the number of lines to shift
     * @param shift
     *            how much scrolling is done. New scrolled area is filled with
     *            <code>'\000</code>'. Negative number means scroll down,
     *            positive scroll up (see example above).
     */
    void scroll(int startLine, int size, int shift);

    /**
     * Adds a new line to the terminal. If maxHeigth is reached, the entire
     * terminal will be scrolled. Else a line will be added.
     */
    void addLine();
    ...
    /**
     * Copy <code>length</code> lines from source starting at sourceLine into
     * this starting at destLine.
     *
     * @param source
