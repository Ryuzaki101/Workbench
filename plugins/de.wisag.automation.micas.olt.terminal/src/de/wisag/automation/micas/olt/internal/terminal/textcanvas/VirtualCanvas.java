...
/**
 * A <code>Canvas</code> showing a virtual object. Virtual: the extent of the
 * total canvas. Screen: the visible client area in the screen.
 */
public abstract class VirtualCanvas extends Canvas {
    ...
    /**
     * Paint the virtual canvas. Override to implement actual paint method.
     *
     * @param gc
    ...
    /**
     * @return the screen rect in virtual space (starting with (0,0)) of the
     *         visible screen. (x,y>=0)
     */
    ...
    /**
     * @return the rect in virtual space (starting with (0,0)) of the visible
     *         screen. (x,y>=0)
     */
    ...
    /**
     * sets the scrolling origin. Also sets the scrollbars. Does NOT redraw! Use
     * negative values (move the virtual origin to the top left to see something
     * in the screen (which is located at (0,0))
     *
     * @param x
     *            TODO
     * @param y
    ...
    /**
     * Called when the viewed part has changed. Override when you need this
     * information.... Is only called if the values change!
     *
     * @param x
     *            visible in virtual space
     * @param y
     *            visible in virtual space
     * @param width
     *            TODO
