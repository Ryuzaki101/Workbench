...
/**
 * A Grid based Canvas. The canvas has rows and columns. CellPainting is done
 * with the abstract method drawCell
 */
abstract public class GridCanvas extends VirtualCanvas {
    ...
    /**
     * template method paint. iterates over all cells in the clipping rectangle
     * and paints them.
     */
    @Override
    protected void paint(GC gc) {
        ...
        // System.out.println(rowFirst+"->"+rowLast+"
     ...
     * information.... Is only called if the values change (well, almost)
     *
     * @param x
     *            origin of visible cells
     * @param y
     *            origin of visible cells
     * @param width
     *            number of cells visible in x direction
     * @param height
     *            number of cells visible in y direction
     */
