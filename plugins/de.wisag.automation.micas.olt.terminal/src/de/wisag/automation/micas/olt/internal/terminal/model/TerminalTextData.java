...
import de.wisag.automation.micas.olt.terminal.model.ITerminalTextDataReadOnly;
...
public class TerminalTextData implements ITerminalTextData {
    ...
    /**
     * Debug helper method -- use as "New Detail Formatter.." in the debugger
     * variables view:
     *
     * <pre>
     ...
     *            start line to show
     * @param len
     *            number of lines to show -- negative numbers means show all
    ...
    static public String toMultiLineText(ITerminalTextDataReadOnly term, int start, int len) {
        ...
        // return buff.toString().replaceAll("\000+", "");
        // //$NON-NLS-1$//$NON-NLS-2$
    ...
    /**
     * Show the first 100 lines see
     * {@link #toMultiLineText(ITerminalTextDataReadOnly, int, int)}
     *
     * @param term
     *            A read-only terminal model
    ...
    /**
     * @param line
     *            notifies snapshots that line line has changed
     */
     ...
     *
     * @param startLine
     *            first line of scrolled region
     * @param size
     *            size of scrolled region (number of lines)
     * @param shift
     *            delta by which the region is scrolled
     */
     ...
     *
     * @param snapshot
     *            A snapshot of a terminal model
     */
