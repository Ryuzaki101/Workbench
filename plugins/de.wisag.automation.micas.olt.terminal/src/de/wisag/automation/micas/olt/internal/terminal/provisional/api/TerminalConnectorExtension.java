...
import de.wisag.automation.micas.olt.internal.terminal.connector.TerminalConnector;
 ...
 *                been added as part of a work in progress. There is no
 *                guarantee that this API will work or that it will remain the
 *                same. Please do not use this API without consulting with the
 *                <a href="http://www.eclipse.org/dsdp/tm/">Target
 *                Management</a> team.
 *                </p>
 */
public class TerminalConnectorExtension {
     ...
     *
     * @param id
     *            the id of the terminal connector in the
     *            <code>de.wisag.automation.micas.olt.terminal.terminalConnectors</code>
     *            extension point
     * @return a new ITerminalConnector with id or <code>null</code> if there is
    ...
    public static ITerminalConnector makeTerminalConnector(String id) {
        IConfigurationElement[] config = RegistryFactory.getRegistry()
                .getConfigurationElementsFor("de.wisag.automation.micas.olt.terminal.terminalConnectors"); //$NON-NLS-1$
    ...
    /**
     * Return a list of available terminal connectors (connection types). The
     * terminal connectors returned are not yet instantiated to any real
     ...
     *         <code>de.wisag.automation.micas.olt.terminal.terminalConnectors</code>
     *         extension point
     * @since de.wisag.automation.micas.olt.terminal 2.0 return value is
     *        ITerminalConnector[]
     */
