...
/**
 * A contributed connection type to manage a single connection. Implementations
 * of this class are contributed through the
 * <code>de.wisag.automation.micas.olt.terminal.terminalConnectors</code>
 * extension point. This class gives access to the static markup of a terminal
 * connector extension as well as providing the lifecycle management for the
 * dynamically loaded {@link TerminalConnectorImpl} instance, which performs the
 * actual communications. This pattern allows for lazy initialization, bundle
 * activation and class loading of the actual {@link TerminalConnectorImpl}
 * instance. Clients can get terminal connector instances from the
 ...
 *         <a href="http://www.eclipse.org/dsdp/tm/">Target Management</a> team.
 *         </p>
 */
public interface ITerminalConnector extends IAdaptable {
     ...
     *         selections.
     * @since de.wisag.automation.micas.olt.terminal 3.0.1
     */
    boolean isHidden();
     ...
     *         {@link #getInitializationErrorMessage()} returns the error
     *         message.
     * @since de.wisag.automation.micas.olt.terminal 2.0
     */
    ...
    /**
     * This method initializes the connector if it is not initialized! If the
     * connector was initialized successfully, <code>null</code> is returned.
