...
public final class Logger {
    public static final String TRACE_DEBUG_LOG = "de.wisag.automation.micas.olt.terminal/debug/log"; //$NON-NLS-1$
    public static final String TRACE_DEBUG_LOG_ERROR = "de.wisag.automation.micas.olt.terminal/debug/log/error"; //$NON-NLS-1$
    public static final String TRACE_DEBUG_LOG_INFO = "de.wisag.automation.micas.olt.terminal/debug/log/info"; //$NON-NLS-1$
    public static final String TRACE_DEBUG_LOG_CHAR = "de.wisag.automation.micas.olt.terminal/debug/log/char"; //$NON-NLS-1$
    public static final String TRACE_DEBUG_LOG_BUFFER_SIZE = "de.wisag.automation.micas.olt.terminal/debug/log/buffer/size"; //$NON-NLS-1$
    ...
    /**
     * Encodes a String such that non-printable control characters are converted
     * into user-readable escape sequences for logging.
     *
     * @param message
     *            String to encode
