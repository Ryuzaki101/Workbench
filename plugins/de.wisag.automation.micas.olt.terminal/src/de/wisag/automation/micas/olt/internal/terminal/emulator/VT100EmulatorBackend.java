...
public class VT100EmulatorBackend implements IVT100EmulatorBackend {
     ...
     * appears in column N. When a character is output to the rightmost column
     * on a given line (column widthInColumns - 1), the cursor moves to column 0
     * on the next line after the character is drawn (this is how line wrapping
     * is implemented). If the cursor is in the bottommost line when line
     * wrapping occurs, the topmost visible line is scrolled off the top edge of
     * the screen.
     * <p>
     */
     ...
     * (non-Javadoc)
     *
     * @see de.wisag.automation.micas.olt.internal.terminal.emulator.
     * IVT100EmulatorBackend#clearAll()
     */
    @Override
     ...
     *
     * @see de.wisag.automation.micas.olt.internal.terminal.emulator.
     * IVT100EmulatorBackend#setDimensions(int, int)
     */
    @Override
        ...
        synchronized (fTerminal) {
            ...
            if (fTerminal.getHeight() == fLines) {
                if (lines < fLines) {
                    ...
                    // for (firstNoneEmptyLine = fTerminal.getHeight();
                    // firstNoneEmptyLine <= 0; firstNoneEmptyLine--) {
                    // LineSegment[] segments =
                    // fTerminal.getLineSegments(firstNoneEmptyLine, 0,
                    // fTerminal.getWidth());
                    // if(segments.length>1)
                    // break;
                    // // is the line empty?
                    // if(segments[0].getText().replaceAll("[\000 ]+",
                    // "").length()==0)
                    // break;
                    // }
                } else {
     ...
     *
     * @see de.wisag.automation.micas.olt.internal.terminal.emulator.
     * IVT100EmulatorBackend#insertCharacters(int)
     */
    @Override
     ...
     *
     * @see de.wisag.automation.micas.olt.internal.terminal.emulator.
     * IVT100EmulatorBackend#eraseToEndOfScreen()
     */
    @Override
     ...
     *
     * @see de.wisag.automation.micas.olt.internal.terminal.emulator.
     * IVT100EmulatorBackend#eraseToCursor()
     */
    @Override
     ...
     *
     * @see de.wisag.automation.micas.olt.internal.terminal.emulator.
     * IVT100EmulatorBackend#eraseAll()
     */
    @Override
     ...
     *
     * @see de.wisag.automation.micas.olt.internal.terminal.emulator.
     * IVT100EmulatorBackend#eraseLine()
     */
    @Override
     ...
     *
     * @see de.wisag.automation.micas.olt.internal.terminal.emulator.
     * IVT100EmulatorBackend#eraseLineToEnd()
     */
    @Override
     ...
     *
     * @see de.wisag.automation.micas.olt.internal.terminal.emulator.
     * IVT100EmulatorBackend#eraseLineToCursor()
     */
    @Override
     ...
     *
     * @see de.wisag.automation.micas.olt.internal.terminal.emulator.
     * IVT100EmulatorBackend#insertLines(int)
     */
    @Override
     ...
     *
     * @see de.wisag.automation.micas.olt.internal.terminal.emulator.
     * IVT100EmulatorBackend#deleteCharacters(int)
     */
    @Override
     ...
     *
     * @see de.wisag.automation.micas.olt.internal.terminal.emulator.
     * IVT100EmulatorBackend#deleteLines(int)
     */
    @Override
     ...
     *
     * @see de.wisag.automation.micas.olt.internal.terminal.emulator.
     * IVT100EmulatorBackend#getDefaultStyle()
     */
    @Override
     ...
     *
     * @see de.wisag.automation.micas.olt.internal.terminal.emulator.
     * IVT100EmulatorBackend#setDefaultStyle(de.wisag.automation.micas.olt.
     * terminal.model.Style)
     */
    @Override
     ...
     *
     * @see de.wisag.automation.micas.olt.internal.terminal.emulator.
     * IVT100EmulatorBackend#getStyle()
     */
    @Override
     ...
     *
     * @see de.wisag.automation.micas.olt.internal.terminal.emulator.
     * IVT100EmulatorBackend#setStyle(de.wisag.automation.micas.olt.terminal.
     * model.Style)
     */
    @Override
     ...
     *
     * @see de.wisag.automation.micas.olt.internal.terminal.emulator.
     * IVT100EmulatorBackend#appendString(java.lang.String)
     */
    @Override
     ...
     *
     * @see de.wisag.automation.micas.olt.internal.terminal.emulator.
     * IVT100EmulatorBackend#processNewline()
     */
    @Override
     ...
     *
     * @see de.wisag.automation.micas.olt.internal.terminal.emulator.
     * IVT100EmulatorBackend#getCursorLine()
     */
    @Override
     ...
     *
     * @see de.wisag.automation.micas.olt.internal.terminal.emulator.
     * IVT100EmulatorBackend#getCursorColumn()
     */
    @Override
     ...
     *
     * @see de.wisag.automation.micas.olt.internal.terminal.emulator.
     * IVT100EmulatorBackend#setCursor(int, int)
     */
    @Override
     ...
     *
     * @see de.wisag.automation.micas.olt.internal.terminal.emulator.
     * IVT100EmulatorBackend#setCursorColumn(int)
     */
    @Override
     ...
     *
     * @see de.wisag.automation.micas.olt.internal.terminal.emulator.
     * IVT100EmulatorBackend#setCursorLine(int)
     */
    @Override
     ...
     *
     * @see de.wisag.automation.micas.olt.internal.terminal.emulator.
     * IVT100EmulatorBackend#getLines()
     */
    @Override
    public int getLines() {
        synchronized (fTerminal) {
     ...
     *
     * @see de.wisag.automation.micas.olt.internal.terminal.emulator.
     * IVT100EmulatorBackend#getColumns()
     */
    @Override
