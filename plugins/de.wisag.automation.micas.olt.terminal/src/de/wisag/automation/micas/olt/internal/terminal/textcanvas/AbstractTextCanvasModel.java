...
abstract public class AbstractTextCanvasModel implements ITextCanvasModel {
    ...
    /**
     * should be called regularly to draw an update of the blinking cursor
     */
    protected void updateCursor() {
        ...
        if (fCursorLine != cursorLine || fCursorColumn != cursorColumn) {
            ...
            // bug 206363: paint also the char to the left and right of the
            // cursor - see also below
    ...
    private void updateSelection() {
        if (fSelectionSnapshot != null && fSelectionSnapshot.isOutOfDate()) {
            ...
            // check if the content of the selection has changed. If the content
            // has
