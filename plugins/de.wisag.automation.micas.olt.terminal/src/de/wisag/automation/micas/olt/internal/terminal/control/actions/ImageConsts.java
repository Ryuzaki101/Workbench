...
public interface ImageConsts {
    ...
    public final static String IMAGE_DIR_LOCALTOOL = IMAGE_DIR_ROOT + "clcl16/"; // basic //$NON-NLS-1$
                                                                                 // colors
                                                                                 // -
                                                                                 // size
                                                                                 // 16x16
    public final static String IMAGE_DIR_DLCL = IMAGE_DIR_ROOT + "dlcl16/"; // disabled //$NON-NLS-1$
                                                                            // -
                                                                            // size
                                                                            // 16x16
    public final static String IMAGE_DIR_ELCL = IMAGE_DIR_ROOT + "elcl16/"; // enabled //$NON-NLS-1$
                                                                            // -
                                                                            // size
                                                                            // 16x16
