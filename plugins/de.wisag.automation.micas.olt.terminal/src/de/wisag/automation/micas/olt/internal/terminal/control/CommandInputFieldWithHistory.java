 ...
 *******************************************************************************/
package de.wisag.automation.micas.olt.internal.terminal.control;
...
/**
 * Manages the Command History for the command line input of the terminal
 * control.
 * <li>
 * <ul>
 ...
 * <ul>
 * History can be edited (by moving up and edit) but changes are not persistent
 * (like in bash).
 * <ul>
 * If the same command is entered multiple times in a row, only one entry is
 * kept in the history.</li>
 */
public class CommandInputFieldWithHistory implements ICommandInputField {
     ...
     *
     * @param line
     *            The line to be added to the history.
     */
    ...
    /**
     * @return the current content of the history buffer and new line separated
     *         list
     */
    ...
    /**
     * @param currLine
     *            Line of text to be moved in history
     * @param count
     *            (+1 or -1) for forward and backward movement. -1 goes back
     * @return the new string to be displayed in the command line or null, if
    ...
    public void createControl(final Composite parent, final ITerminalViewControl terminal) {
        ...
        fSash.addListener(SWT.Selection, new Listener() {
            ...
            public void handleEvent(Event e) {
                ...
                // make sure the input filed hight is a multiple of the line
                // height
        ...
        if (installDecoration) {
            // The ContentAssistCommandAdapter says: "The client is responsible
            // for
