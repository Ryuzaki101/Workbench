...
class TerminalToRemoteInjectionOutputStream extends FilterOutputStream {
    /**
     * This class handles bytes written to the
     * {@link TerminalToRemoteInjectionOutputStream}.
     */
    static abstract public class Interceptor {
        ...
        /**
         * @param original
         *            the injection into the original stream begins
         * @throws IOException
         *             TODO
         */
    ...
    /**
     * There can only be one injection stream active at a time. You must call
     * close on the returned output stream to end the injection.
     *
     * @param interceptor
     *            This is used handle bytes sent while the injection stream is
     *            active.
     * @return a output stream that can be used to write to the decorated
     *         stream.
     * @throws IOException
     *             TODO
     */
    ...
    /**
     * See
     * {@link #grabOutput(TerminalToRemoteInjectionOutputStream.Interceptor)}.
     *
