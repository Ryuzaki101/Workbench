...
/**
 * This class stores the data only within a window {@link #setWindow(int, int)}
 * and {@link #getWindowStartLine()} and {@link #getWindowSize()}. Everything
 * outside the is <code>char=='\000'</code> and <code>style=null</code>.
 */
