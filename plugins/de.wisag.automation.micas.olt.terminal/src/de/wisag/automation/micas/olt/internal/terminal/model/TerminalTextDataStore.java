...
public class TerminalTextDataStore implements ITerminalTextData {
     ...
     *
     * @see
     * de.wisag.automation.micas.olt.internal.terminal.text.ITerminalTextData#
     * getWidth()
     */
    @Override
    public int getWidth() {
     ...
     * @param newSize
     *            the new array size.
     * @return A new array with the same contents (chopped off if needed or
     ...
     * de.wisag.automation.micas.olt.internal.terminal.text.Style)
     */
    @Override
    ...
    public void scroll(int startLine, int size, int shift) {
        ...
        if (shift < 0) {
            ...
            // cleanLines(Math.max(0, startLine+size+shift),Math.min(-shift,
            // getHeight()-startLine));
        } else {
    ...
    /*
     * @return a text representation of the object. Lines are separated by '\n'.
