...
/**
 * The public methods of this class have to be called from one thread! Threading
 * considerations: This class is <b>not threadsafe</b>!
 */
class TerminalTextDataSnapshot implements ITerminalTextDataSnapshot {
    ...
    /**
     * Keeps track of changes that happened since the current snapshot has been
     * made.
     */
    ISnapshotChanges fFutureChanges;
    /**
     * Is used as lock and is the reference to the terminal we take snapshots
     * from.
     */
    ...
    /**
     * This is used in asserts to throw an {@link RuntimeException}. This is
     * useful for tests.
     *
     ...
     * (non-Javadoc)
     *
     * @see de.wisag.automation.micas.olt.internal.terminal.model.
     ...
     *
     * @see de.wisag.automation.micas.olt.internal.terminal.model.
     * ITerminalTextDataSnapshot#getFirstChangedLine()
     */
    @Override
     ...
     *
     * @see de.wisag.automation.micas.olt.internal.terminal.model.
     * ITerminalTextDataSnapshot#getLastChangedLine()
     */
    @Override
     ...
     *
     * @see de.wisag.automation.micas.olt.internal.terminal.model.
     * ITerminalTextDataSnapshot#getScrollChangeY()
     */
    @Override
     ...
     *
     * @see de.wisag.automation.micas.olt.internal.terminal.model.
     * ITerminalTextDataSnapshot#getScrollChangeN()
     */
    @Override
     ...
     *
     * @see de.wisag.automation.micas.olt.internal.terminal.model.
     * ITerminalTextDataSnapshot#getScrollChangeShift()
     */
    @Override
