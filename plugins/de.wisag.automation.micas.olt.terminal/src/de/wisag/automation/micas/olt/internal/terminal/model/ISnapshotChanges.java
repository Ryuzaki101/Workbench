...
public interface ISnapshotChanges {
    ...
    /**
     * @param line
     *            might bigger than the number of lines....
     */
    ...
    /**
     * Marks all lines within the scrolling region changed and resets the
     ...
     *
     * @param height
     *            if no window is set this is the number of lines that are
     *            marked as changed
     */
    ...
    /**
     * @param startLine
     *            -1 means follow the end of the data
     * @param size
