...
public class DiffMatchPatch {
    ...
    protected LinkedList<Diff> diff_map(String text1, String text2) {
        ...
        List<Set<String>> v_map1 = new ArrayList<>();
        List<Set<String>> v_map2 = new ArrayList<>();
     ...
     */
    protected LinkedList<Diff> diff_path1(List<Set<String>> v_map, String text1, String text2) {
     ...
     * @return LinkedList of Diff objects.
     */
    protected LinkedList<Diff> diff_path2(List<Set<String>> v_map, String text1, String text2) {
        LinkedList<Diff> path = new LinkedList<>();
        int x = text1.length();
        int y = text2.length();
        Operation last_op = null;
    ...
    protected String diff_footprint(int x, int y) {
        // Performance note: Inlining this function seems to slow down
        // execution.
        return x + "," + y;
    }
    ...
    public String diff_prettyHtml(LinkedList<Diff> diffs) {
        ...
        for (Diff aDiff : diffs) {
            ...
            case INSERT:
                html.append("<INS STYLE=\"background:#E6FFE6;\" TITLE=\"i=").append(i).append("\">").append(text)
                        .append("</INS>");
                break;
            case DELETE:
