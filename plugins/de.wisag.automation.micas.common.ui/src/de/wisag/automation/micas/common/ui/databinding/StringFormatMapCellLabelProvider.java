 ...
 */
public class StringFormatMapCellLabelProvider extends ObservableMapCellLabelProvider {
     ...
     */
    public StringFormatMapCellLabelProvider(String messagePattern, IObservableMap... attributeMaps) {
        super(attributeMaps);
    ...
    protected String format(Object... values) {
        return String.format(messagePattern, values);
    }
}