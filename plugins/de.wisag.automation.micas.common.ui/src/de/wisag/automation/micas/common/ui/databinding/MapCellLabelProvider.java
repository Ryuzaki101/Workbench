 ...
 */
public abstract class MapCellLabelProvider extends ObservableMapCellLabelProvider {
     ...
     */
    public MapCellLabelProvider(IObservableMap<?, ?>... attributeMaps) {
        super(attributeMaps);
    ...
    protected abstract String format(Object... values);
