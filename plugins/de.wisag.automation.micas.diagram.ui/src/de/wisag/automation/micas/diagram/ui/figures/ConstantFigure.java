...
public class ConstantFigure extends StandardComponentFigure implements IFigureConstants {

    public ConstantFigure() {
        LabelEx figure = new LabelEx();
        add(figure);
    }
    ...
    protected void paintCanvas(ICanvasContext cc) {
        ...
        cc.drawRectangle(DEFAULT_LINE_WIDTH_HALF, DEFAULT_LINE_WIDTH_HALF, size.width - DEFAULT_LINE_WIDTH,
