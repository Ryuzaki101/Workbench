...
public class UserValidationDialog extends TrayDialog {
     ...
     * @param message
     *            a mesage to display to the user
     */
    ...
    protected Control createDialogArea(Composite parent) {
        ...
        // keyLockImage =
        // TeamImages.getImageDescriptor(ITeamUIImages.IMG_KEY_LOCK).createImage();
    ...
    /**
     * Returns the password entered by the user, or null if the user cancelled.
     *
    ...
    /**
     * Returns the username entered by the user, or null if the user cancelled.
     *
    ...
    /**
     * Sets whether or not the username field should be mutable. This method
