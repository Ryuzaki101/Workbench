...
public class Activator extends Plugin {
    ...
    public static final String PLUGIN_ID = "de.wisag.automation.micas.olt.terminal.ssh"; //$NON-NLS-1$
    ...
    // ---------------------------------------------------------------------------
    // <copied code from org.eclipse.team.cvs.ssh2/CVSSSH2Plugin (Copyright
    // IBM)>
    // ---------------------------------------------------------------------------
