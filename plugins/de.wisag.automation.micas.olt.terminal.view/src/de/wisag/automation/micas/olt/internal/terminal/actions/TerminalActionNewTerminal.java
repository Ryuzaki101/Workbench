...
public class TerminalActionNewTerminal extends TerminalAction implements IMenuCreator {
    ...
    public TerminalActionNewTerminal(ITerminalView target) {
        ...
        setupAction(ActionMessages.NEW_TERMINAL_CONNECTION, ActionMessages.NEW_TERMINAL_CONNECTION,
                ImageConsts.IMAGE_NEW_TERMINAL, ImageConsts.IMAGE_NEW_TERMINAL, ImageConsts.IMAGE_NEW_TERMINAL, true);
        setMenuCreator(this);
    }
    ...
    public Menu getMenu(Control parent) {
        if (fMenu == null) {
            ...
            addActionToMenu(fMenu, new Action(ActionMessages.NEW_TERMINAL_CONNECTION) {
                @Override
                public void run() {
                    fTarget.onTerminalNewTerminal();
                }
            ...
            addActionToMenu(fMenu, new Action(ActionMessages.NEW_TERMINAL_VIEW) {
                @Override
                public void run() {
