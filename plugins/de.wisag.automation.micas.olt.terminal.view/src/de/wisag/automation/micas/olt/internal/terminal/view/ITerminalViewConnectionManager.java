...
public interface ITerminalViewConnectionManager {
    ...
    /**
     * Used to create instances of the ITerminalViewConnection when the state is
     * read from the {@link ISettingsStore}
     */
    ...
    /**
     * @param conn
     *            make this connection the active connection
     */
     ...
     * @param store
     * @param factory
     *            used to create new {@link ITerminalViewConnection}
     */
