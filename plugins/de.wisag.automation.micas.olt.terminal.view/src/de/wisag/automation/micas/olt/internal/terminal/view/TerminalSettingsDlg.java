...
class TerminalSettingsDlg extends Dialog {
            ...
            if (fConnectors[i].getInitializationErrorMessage() != null) {
                ...
                fPages[i] = new ISettingsPage() {
                    ...
                    public void createControl(Composite parent) {
                        ...
                        String msg = NLS.bind(ViewMessages.CANNOT_INITIALIZE, conn.getName(),
    ...
    /**
     * Increase the size of this dialog's <code>Shell</code> by the specified
     * amounts. Do not increase the size of the Shell beyond the bounds of the
     * Display.
     */
    ...
    protected Control createDialogArea(Composite parent) {
        ...
        PlatformUI.getWorkbench().getHelpSystem().setHelp(ctlComposite,
                TerminalViewPlugin.HELPPREFIX + "terminal_settings"); //$NON-NLS-1$
    ...
    private int getInitialConnector() {
        ...
        for (int i = 0; i < fConnectors.length; i++) {
            if ("de.wisag.automation.micas.olt.internal.terminal.telnet.TelnetConnector"
                    .equals(fConnectors[i].getId())) {
                return i;
            }
        }
