...
public class TerminalActionToggleCommandInputField extends TerminalAction {
    public TerminalActionToggleCommandInputField(ITerminalView target) {
        super(target, TerminalActionToggleCommandInputField.class.getName(), IAction.AS_RADIO_BUTTON);

        setupAction(ActionMessages.TOGGLE_COMMAND_INPUT_FIELD, ActionMessages.TOGGLE_COMMAND_INPUT_FIELD,
                ImageConsts.IMAGE_CLCL_COMMAND_INPUT_FIELD, ImageConsts.IMAGE_ELCL_COMMAND_INPUT_FIELD,
                ImageConsts.IMAGE_DLCL_COMMAND_INPUT_FIELD, true);
