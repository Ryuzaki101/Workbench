...
/**
 * A {@link IDialogSettings} based {@link ISettingsStore}. Setting Store based
 * on IMemento. IMemento documentations says only alpha numeric values may be
 * used as keys. Therefore the implementation converts dots (.) into child
 * elements of the memento.
 *
        ...
        if (keys != null) {
            ...
            for (int i = 0; i < keyNames.length; i++) {
                ...
                if (!KEYS.equals(key)) {
                    ...
                    IMemento m = memento;
                    // iterate over all but the last segment and get the
                    // children...
