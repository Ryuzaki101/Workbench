...
public interface ImageConsts {
    ...
    public final static String IMAGE_DIR_LOCALTOOL = "clcl16/"; // basic //$NON-NLS-1$
                                                                // colors - size
                                                                // 16x16
    public final static String IMAGE_DIR_DLCL = "dlcl16/"; // disabled //$NON-NLS-1$
                                                           // - size 16x16
    public final static String IMAGE_DIR_ELCL = "elcl16/"; // enabled //$NON-NLS-1$
                                                           // - size 16x16
