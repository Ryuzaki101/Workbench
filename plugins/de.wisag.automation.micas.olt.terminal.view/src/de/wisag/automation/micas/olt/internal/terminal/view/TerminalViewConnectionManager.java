...
public class TerminalViewConnectionManager implements ITerminalViewConnectionManager {
    ...
    /**
     * The list of {@link ITerminalViewConnection} in the order they were
     * cerated. Ordered by creation time
     */
    ...
    /**
     * The list of {@link ITerminalViewConnection} in the order they were made
     * the active connection. The most recently accessed connection is at the
    ...
    /**
     * @return the connection that was most recently the active connection or
     *         null if there is no previous connection
     */
    ...
    protected void fireListeners() {
        ITerminalViewConnectionListener[] listeners = (ITerminalViewConnectionListener[]) fListeners
                .toArray(new ITerminalViewConnectionListener[fListeners.size()]);
        ...
        if (size > 0) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                try {
                    ...
                    // in case something goes wrong, make sure we can read the
                    // other
                    // connections....
                    TerminalViewPlugin.getDefault().getLog()
                            .log(new Status(IStatus.WARNING,
                                    TerminalViewPlugin.getDefault().getBundle().getSymbolicName(), 0,
