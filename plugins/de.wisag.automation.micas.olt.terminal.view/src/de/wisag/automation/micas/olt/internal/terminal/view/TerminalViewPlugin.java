...
public class TerminalViewPlugin extends AbstractUIPlugin {
    ...
    public static final String HELPPREFIX = "de.wisag.automation.micas.olt.terminal.view."; //$NON-NLS-1$
    ...
    protected void loadImageRegistry(ImageRegistry imageRegistry, String strDir, HashMap map)
        ...
        while (keys.hasNext()) {
            ...
            if (strFile != null) {
                url = TerminalViewPlugin.getDefault().getBundle()
                        .getEntry(ImageConsts.IMAGE_DIR_ROOT + strDir + strFile);
