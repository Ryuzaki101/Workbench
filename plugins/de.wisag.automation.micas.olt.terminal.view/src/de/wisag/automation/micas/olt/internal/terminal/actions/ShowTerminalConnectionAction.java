...
import de.wisag.automation.micas.olt.internal.terminal.view.ITerminalViewConnection;
...
public class ShowTerminalConnectionAction extends Action {
     ...
     *
     * @param manager
     *            the terminal multi-view in which the given terminal connection
     *            is contained
     * @param connection
     *            the terminal view connection
     */
    ...
    /**
     * the tab at the end quotes '@' chars?!? see {@link #setText(String)}
     *
     * @param name
     ...
     * partNames (the names showed in the view title) then this name is
     * prefixed.
     *
     * @param m
     *            the connection manager
     * @param connection
     *            the connection for which the name should me extracted
