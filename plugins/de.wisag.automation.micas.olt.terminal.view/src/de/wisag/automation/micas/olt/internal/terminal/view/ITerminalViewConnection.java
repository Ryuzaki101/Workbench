...
/**
 * Represents a connection. The connection might be connected or not.
 */
public interface ITerminalViewConnection {

    /**
     * @return the summary shown in the status line and in the drop down box of
     *         the connections
     */
    ...
    /**
     * @param on
     *            turns the input field on
     */
    void setCommandInputField(boolean on);

    /**
     * @param state
     *            changes of the state (might change the summary)
     */
    void setState(TerminalState state);

    /**
     * @param title
     *            used in the summary. If null the summary is created
     *            automatically
     */
