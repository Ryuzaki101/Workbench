 ...
 * {@link de.wisag.automation.micas.module.Attribute} object. <!--
...
public class AttributeItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
        ...
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_Attribute_name_feature",
                                "_UI_Attribute_type"),
                        ModulePackage.Literals.ATTRIBUTE__NAME, true, false, false,
    ...
    protected void addDataTypePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_Attribute_dataType_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_Attribute_dataType_feature",
                                "_UI_Attribute_type"),
                        ModulePackage.Literals.ATTRIBUTE__DATA_TYPE, true, false, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
        ...
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", "_UI_Attribute_description_feature",
                                "_UI_Attribute_type"),
                        ModulePackage.Literals.ATTRIBUTE__DESCRIPTION, true, false, false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
