...
/**
 * This is the action bar contributor for the Module model editor. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 *
 * @generated
 */
public class ModuleActionBarContributor extends EditingDomainActionBarContributor implements ISelectionChangedListener {
    /**
    ...
    protected IAction showPropertiesViewAction = new Action(
            ModuleEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
        @Override
        public void run() {
            try {
    ...
    protected IAction refreshViewerAction = new Action(
            ModuleEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
        @Override
     ...
     * @generated
     */
    public ModuleActionBarContributor() {
    ...
    public void contributeToToolBar(IToolBarManager toolBarManager) {
        toolBarManager.add(new Separator("module-settings"));
        toolBarManager.add(new Separator("module-additions"));
    }
    ...
    public void contributeToMenu(IMenuManager menuManager) {
        ...
        IMenuManager submenuManager = new MenuManager(ModuleEditorPlugin.INSTANCE.getString("_UI_ModuleEditor_menu"),
                "de.wisag.automation.micas.moduleMenuID");
        ...
        //
        createChildMenuManager = new MenuManager(ModuleEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
        submenuManager.insertBefore("additions", createChildMenuManager);

        // Prepare for CreateSibling item addition or removal.
        //
        createSiblingMenuManager = new MenuManager(
                ModuleEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
    ...
    public void menuAboutToShow(IMenuManager menuManager) {
        ...
        submenuManager = new MenuManager(ModuleEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
        populateManager(submenuManager, createChildActions, null);
        menuManager.insertBefore("edit", submenuManager);

        submenuManager = new MenuManager(ModuleEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
