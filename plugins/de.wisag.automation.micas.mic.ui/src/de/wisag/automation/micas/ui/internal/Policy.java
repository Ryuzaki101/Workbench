package de.wisag.automation.micas.ui.internal;
...
public class Policy {
    ...
    private static ILog getLog() {
        return MicActivator.getInstance().getLog();
    }
    ...
    public static void logWarning(String message) {
        new Status(IStatus.WARNING, MicActivator.getInstance().getBundle().getSymbolicName(), message);
