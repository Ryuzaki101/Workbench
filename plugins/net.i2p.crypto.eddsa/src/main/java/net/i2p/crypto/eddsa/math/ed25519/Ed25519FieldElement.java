...
/**
 * Class to represent a field element of the finite field $p = 2^{255} - 19$
 * elements.
 * <p>
...
public class Ed25519FieldElement extends FieldElement {
	 ...
	 *
	 * @param f
	 *            The underlying field, must be the finite field with $p = 2^{255} -
	 *            19$ elements
	 * @param t
	 ...
	 * $h = f + g$
	 * <p>
	 * TODO-CR BR: $h$ is allocated via new, probably not a good idea. Do we need
	 * the copying into temp variables if we do that?
	 * <p>
	 * Preconditions:
	 * </p>
	 * <ul>
	 ...
	 * @param b
	 *            must be 0 or 1, otherwise results are undefined.
