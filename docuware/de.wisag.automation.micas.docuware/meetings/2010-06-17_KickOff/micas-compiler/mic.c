...
{ 0X302F,"ANEIN", sizeof(ANEIN_PTyp)/sizeof(Typ),   0,    100, NULL,
		                                0,  ANEIN_PTyp,  NULL       },

{ 0X3030,"ZWEIN", sizeof(ZWEIN_PTyp)/sizeof(Typ),  0,    100, NULL,
		                                0,  ZWEIN_PTyp,  NULL       },

{ 0X3031,"MELEIN",sizeof(MELEIN_PTyp)/sizeof(Typ),  2,    100, NULL,
		  sizeof(MELEIN_GTyp)/sizeof(GTyp), MELEIN_PTyp, MELEIN_GTyp},

{ 0X3032,"ANAUS" ,sizeof(ANAUS_PTyp)/sizeof(Typ) ,  6,    100, NULL,
		                                0,  ANAUS_PTyp,  NULL       },

{ 0X3033,"BEFAUS",sizeof(BEFAUS_PTyp)/sizeof(Typ),  4,    100, NULL,
		                                0,  BEFAUS_PTyp, NULL       },

{ 0X3034,"SETMEL",sizeof(SETMEL_PTyp)/sizeof(Typ),  4,    100, NULL,
		  sizeof(SETMEL_GTyp)/sizeof(GTyp), SETMEL_PTyp, SETMEL_GTyp},

{ 0X3035,"ZWAUS", sizeof(ZWAUS_PTyp)/sizeof(Typ),   0,    100, NULL,
		                                0,  ZWAUS_PTyp,	 NULL       },
